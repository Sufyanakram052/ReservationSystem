...
Public Class Places
    ...
    Protected Sub saveAdmin1_Click(sender As Object, e As EventArgs) Handles saveAdmin1.Click
        ...
        If Key > 0 Then
            ...
            If NameS.Text = "" Or LocationS.Text = "" Or PriceS.Text = "" Then
                MsgBox("Please fill all the fieldes.")
            Else
                Con.Open()
                Dim query As String
                query = "Update Places set Name='" & NameS.Text & "',Location='" & LocationS.Text & "',Price='" & PriceS.Text & "',Status='" & Status & "' where Id='" & Key & "'"
        ...
        Else
            ...
            Else
                Try
                    ...
                    Dim insertQuery As String = "INSERT INTO Places (Id, Name, Location, Price, Status) VALUES (@Id, @Name, @Location, @Price, @Status)"
